...
const ACTIONS: Record<string, string> = {
  ...
  A2: "Create a dedicated K-Beauty & Skincare section. Sheet Masks, Serums, and Glass Skin Kits exist on Shopsy but are buried under generic categories — Gen Z can't find them. 34% of Indian Gen Z actively plan to explore Korean skincare (YouGov 2025). Neither platform has a curated K-Beauty surface yet.",
  A3: "Create a dedicated Creator Tools section. Ring Lights and Microphones exist on Shopsy under generic electronics — but there is no Creator Tools discovery surface. Ring lights were Meesho's #1 electronics item H1 2024. Neither platform surfaces these for content creators. First-mover window is open.",
